...
Private Package Forth.Pools with Elaborate_Body is --Preelaborate
    use System.Storage_Pools, System.Storage_Elements;

     type User_Pool is new
           System.Storage_Pools.Root_Storage_Pool with null record; --private;
   ...
   function Mark (Pool : in out Mark_Release_Pool_Type)
    ...
    Forth_Memory : Root_Storage_Pool'Class:=
		      User_Pool'(Root_Storage_Pool with null record);
